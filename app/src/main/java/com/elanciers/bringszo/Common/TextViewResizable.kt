...
import android.widget.TextView
    ...
    fun TextViewResizable(tv: TextView, maxLine: Int, expandText: String, viewMore: Boolean) {
            ...
            ssb.setSpan(object : MySpannable(false) {
                override fun onClick(widget: View) {
                    if (viewMore) {
                        ...
                        tv.invalidate()
                        TextViewResizable(tv, -1, "See Less", false)
                    } else {
                        tv.layoutParams = tv.layoutParams
                        tv.setText(tv.tag.toString(), TextView.BufferType.SPANNABLE)
                        tv.invalidate()
                        TextViewResizable(tv, 3, ".. See More", true)
                    }
                }
