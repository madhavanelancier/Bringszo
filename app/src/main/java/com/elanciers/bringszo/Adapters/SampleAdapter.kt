...
import com.elanciers.bringszo.Common.SampleModel
...
class SampleAdapter : CarouselAdapter() {
    ...
    inner class MyViewHolder(itemView: View) : CarouselViewHolder(itemView) {
        ...
        var title: ImageView = itemView.findViewById(R.id.imageView6)
    ...
    inner class EmptySampleModel constructor(private val text: String) : CarouselModel() {
